...
orig_coords <- samp@images$R1102C@boundaries$centroids@coords
...
samp@images$R1102C@boundaries$centroids@coords <- coords_new

SpatialDimPlot(samp)

saveRDS(samp, file = "P3_Core_20250414.rds")
