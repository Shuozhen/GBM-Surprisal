...
orig_coords <- samp@images$GBM1031N@boundaries$centroids@coords
...
samp@images$GBM1031N@boundaries$centroids@coords <- coords_new

SpatialDimPlot(samp)
saveRDS(samp, file = "P2_Peripheral_20250414.rds")
