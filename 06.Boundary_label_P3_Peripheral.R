...
orig_coords <- samp@images$R1102N@boundaries$centroids@coords
...
samp@images$R1102N@boundaries$centroids@coords <- coords_new

SpatialDimPlot(samp)
samp_list[[6]] <- samp


saveRDS(samp, file = "P3_Peripheral_20250414.rds")
