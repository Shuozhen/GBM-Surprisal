...
orig_coords <- samp@images$R0103C@boundaries$centroids@coords
...
bins_to_remove_row <- c(47,48,49,50)
bins_to_remove_col <- c(4, 44, 45)
...
samp@images$R0103C@boundaries$centroids@coords <- coords_new
...
saveRDS(samp, file = "P5_Peripheral_20250414.rds")
