...
samp <- readRDS("/gpfs/gibbs/project/fan/gil5/Transfer/P4_Core_20250409.rds")
...
samp <- FindClusters(samp, resolution = 0.2)
DimPlot(samp)
SpatialDimPlot(samp)
...
saveRDS(samp, file = "P4_Core_20250414_NICHES.rds")