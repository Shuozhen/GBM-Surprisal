...
samp <- readRDS("/gpfs/gibbs/project/fan/gil5/Transfer/P3_Core_20250414.rds")
...
samp <- FindClusters(samp, resolution = 0.15)
DimPlot(samp)
SpatialDimPlot(samp)
...
saveRDS(samp, file = "P3_Core_20250414_NICHES.rds")
